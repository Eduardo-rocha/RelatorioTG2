...
\documentclass[11pt,a4paper,openright,titlepage,twoside]{book}
...
\membrodabancaii{Prof. Antônio Padilla L. Bó, ENE/UnB}
\membrodabancaiifuncao{Examinador interno}
\membrodabancaiii{Prof. Eduardo Stockler Tognetti, ENE/UnB}
...
\dedicatoriaautori{Aos meus pais, Evandro e Rosana, e aos meus irmãos, Pedro e Filipe.}
...
\agradecimentosautori{\textit{Aos meus pais e família, pelo amor, incentivo e apoio incondicional.}

\textit{A todos os professores com quem tive a oportunidade de ter aulas e trabalhar na Universidade de Brasília, não apenas por me proporcionarem o conhecimento necessário para a minha graduação, mas também por me incentivarem e me guiarem durante esses cinco anos.}

\textit{Aos professores Erick Oberstar e Guilherme Carvalho que possibilitaram a realização desse trabalho.}
 
\textit{A todos os profissionais da Universdade de Wisconsin que me ajudaram durante a realização desse trabalho.}
  
\textit{A todos meus colegas de curso que me acompanharam e me ajudaram durante esses últimos cinco anos.}}
...
% incluso no cap_ProjetoAutomacao 

% *** Desenvolvimento ***
\include{capitulos/cap_ProjetoMecanico}
\include{capitulos/cap_ProjetoAutomacao}
\include{capitulos/cap_ProjetoControlador}
\include{capitulos/cap_Programacao}% +Modelagem sinais
...
% diagramas elétricos e desenhos mecânicos e visu2
